...
from bot.flood_control import FloodControl
from bot.telegram_network import patch_telegram_transport
...
def start_bot(bot_token, socks):
    # Patch Telegram network for DNS-restricted environments
    patch_telegram_transport()
    ...
    # Wrap bot with flood control
    flood_control = FloodControl(application.bot)
    application.bot = flood_control
